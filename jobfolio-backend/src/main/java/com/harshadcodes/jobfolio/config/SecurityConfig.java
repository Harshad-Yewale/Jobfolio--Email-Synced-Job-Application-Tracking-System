...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowCredentials(true); // critical — allows cookies to be sent/received
        configuration.setExposedHeaders(List.of("XSRF-TOKEN")); // so JS can read it if needed
